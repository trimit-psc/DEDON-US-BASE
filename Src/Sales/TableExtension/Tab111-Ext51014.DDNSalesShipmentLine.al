tableextension 51014 "DDN Sales Shipment Line" extends "Sales Shipment Line" //111
{
    fields
    {
        /// <summary>
        ...
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Sales Shipment Header"."COR-DDN Respons. Person Code" where("No." = field("Document No.")));
